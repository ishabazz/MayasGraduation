            ...
            <Container className="my-4">
                ...
                <Row className="justify-content-center pt-4">
                    <Col md={6} sm={10} xs={10} className="invite text-center rounded py-5">
                        ...
                        <h3 className="h1 event-name text-white mb-4">Virtual Grad Party</h3>
                        <a href="https://us02web.zoom.us/w/86209044783?tk=0ENeQsWZKxX7S-J5wOPCY3NYmzl6ldB8pgYuwx-6J3E.DQIAAAAUEnWhLxZlbnppTzMtd1M1T0VPQ0Fqai1WeHR3AAAAAAAAAAAAAAAAAAAAAAAAAAAA" className="btn-info btn event-link">Join the Watch Party Here</a>
                    </Col>
                </Row>
